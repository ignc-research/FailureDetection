...
def do_predict(pred_func, input_file):
    ...
    print("."+"Inference for {} written to {}".format(base_name, result_file))
    #logger.info("Inference output for {} written to {}".format(input_file, result_file))
    #tpviz.interactive_imshow(viz)
...
if __name__ == '__main__':
    ...
    if args.visualize:
        ...
        if args.predict:
            ...
            predictor = OfflinePredictor(predcfg)
            print("...................................................................................................................................................................")
            print(args.predict[0])
            print("{}/*.jpg".format(args.predict[0]))
            image_list = []
            for img in glob.glob("{}/*.jpg".format(args.predict[0])):
                img_number += 1
