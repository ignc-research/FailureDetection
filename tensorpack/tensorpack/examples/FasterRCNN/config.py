...
_C.MODE_MASK = False        # True for Faster R-CNN or False for Mask R-CNN
_C.MODE_FPN = True
...
_C.DATA.TRAIN = ('train2019',)   # i.e. trainval35k
# Each VAL dataset will be evaluated separately (instead of concatenated)
_C.DATA.VAL = ('val2019',)  # AKA minival2014
...
_C.TEST.RESULT_SCORE_THRESH = 0.3 # default 0.05
